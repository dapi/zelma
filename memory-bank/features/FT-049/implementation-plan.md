...
| Boundary review | `REQ-02`, `NEG-01`, `INV-01` | Existing code separates status/live/registry | Static search/code review for direct UI-layer registry parsing | `rg -n "instances.json|registry\\.Load|registry\\.Read|os\\.ReadFile" internal/cli internal/monitor` plus code review | N/A unless docs lint exists | N/A | `none` |
