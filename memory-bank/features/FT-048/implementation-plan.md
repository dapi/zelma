...
Создать и проверить repo-local Codex skill package `skills/zelma/` так, чтобы
...
| `../../../skills/` | Target skill package root | Currently absent before FT-048 | Create `skills/zelma/` |
...
| --- | --- | --- | --- | --- |
| `WS-1` | `REQ-01`-`REQ-07`, `SOL-01`, `SOL-02`, `CTR-01`-`CTR-07` | `skills/zelma/SKILL.md` and metadata exist | agent | `PRE-01` |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `STEP-01` | agent | `REQ-01`, `SOL-01` | Create `skills/zelma/` package skeleton | `skills/zelma/` | Directory with `SKILL.md` | `CHK-01` | `EVID-01` | Static file review | `PRE-01` | `none` | Package path conflicts with existing non-skill content |
| `STEP-02` | agent | `REQ-02`, `REQ-03`, `REQ-05`, `SOL-01`, `CTR-01`-`CTR-07` | Write concise `SKILL.md` intent routing and recovery guidance | `skills/zelma/SKILL.md` | Skill instructions | `CHK-01`, `CHK-02` | `EVID-01`, `EVID-02` | Compare with `skill-contract.md` | `PRE-01` | `none` | Existing CLI contract lacks a required command |
| `STEP-03` | agent | `REQ-07`, `SOL-02`, `SD-02` | Add OpenAI UI metadata | `skills/zelma/agents/openai.yaml` | Metadata file | `CHK-01`, `CHK-04` | `EVID-01`, `EVID-04` | Static metadata review | `PRE-02` | `none` | Metadata requires behavioral fields not covered by design |
| `STEP-04` | agent | `REQ-04`, `REQ-06`, `INV-01`-`INV-04` | Review and tighten safety boundaries | `skills/zelma/SKILL.md`, `skills/zelma/agents/openai.yaml` | Boundary-safe instructions | `CHK-03` | `EVID-03` | `rg` static searches and manual verdict | `STEP-02`, `STEP-03` | `none` | Direct zellij or registry parsing appears necessary |
