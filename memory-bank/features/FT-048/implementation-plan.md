...
| Safety boundary | `REQ-04`, `REQ-06`, `NEG-01`, `NEG-02`, `INV-01`-`INV-03` | Upstream docs state boundary | Static search for direct `zellij`, direct registry parsing and ungated cleanup confirm guidance | `rg -n "zellij|instances.json|cleanup --confirm" skills/zelma memory-bank/features/FT-048` | N/A unless docs lint exists | N/A | `none` |
