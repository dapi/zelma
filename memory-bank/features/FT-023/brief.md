...
Codex skills вызывают `zelma instances list/create/detect/focus` и интерпретируют
...
- `NS-02` Нет отдельного parser `.zelma/instances.json`.
...
- `SC-01` Skill wrapper вызывает `zelma instances list`.
