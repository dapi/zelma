...
- [Codex Skill Contract](skill-contract.md) — agent-facing contract для Codex skills поверх `zelma sessions list/create/detect/focus/cleanup`, machine-readable outputs, recovery и boundaries.
