...
- [Codex Skill Contract](skill-contract.md) — agent-facing contract для Codex skills поверх `zelma sessions list/create/detect/cleanup`, machine-readable outputs, recovery и boundaries.
